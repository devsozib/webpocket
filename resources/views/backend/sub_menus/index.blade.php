                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Sub Menu</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Sub Menu</a></li>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <h5 class="card-title mb-0">Sub Menu List</h5>
                                    </div>
                                    <div>
                                        <button type="button" data-bs-toggle="modal" data-bs-target="#add-modal"
                                            ...
                                            data-text="Click"><span>Sub Menu Create</span></button>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content border-0 overflow-hidden">
                                                    <div class="modal-header p-3">
                                                        <h4 class="card-title mb-0">Create Sub Menu</h4>
                                                ...
                                                <td>
                                                                ...
                                                                <div class="modal-body text-center p-5">
                                                                    <div class="mt-4 pt-4">
                                                                        ...
                                                                        <p class="text-muted">Please click the delete
                                                                            button!</p>
                                                                        <form
                                                                            action="{{ route('sub_menus.destroy', $menu->id) }}"
                                                                            method="post">
                                                                            @csrf
                                                                            @method('delete')
                                                    ...
                                                    <div id="edit-modal{{ $menu->id }}" class="modal fade"
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content border-0 overflow-hidden">
                                                                <div class="modal-header p-3">
                                                                    <h4 class="card-title mb-0">Edit Sub Menu</h4>
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <form
                                                                        action="{{ route('sub_menus.update', $menu->id) }}"
                                                                        method="post">
                                                                        @csrf
                                                                        @method('PATCH')
                                                                        ...
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <select class="form-select mb-3"
                                                                                ...
                                                                                @foreach ($menus as $menuitem)
                                                                                    <option
                                                                                        {{ $menuitem->id == $menu->menu_id ? 'selected' : '' }}
                                                                                        value="{{ $menuitem->id }}">
                                                                        ...
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <input type="text" class="form-control"
                                                                                ...
                                                                                name="display_name"
                                                                                value="{{ old('display_name', $menu->s_name) }}">
                                                                        </div>
                                                                        <div class="mb-3">
                                                                            <label for="emailInput"
