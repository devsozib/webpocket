        ...
        <div class="navbar-header">
            <div class="d-flex">
                ...
                <a href="{{ url('/') }}" target="_blank"
                    class="btn btn-sm px-3 fs-16 header-item vertical-menu-btn topnav-hamburger"><i
                        class="bx bx-world fs-22"></i></a>
            </div>
                        ...
                        <button type="button" class="btn" id="page-header-user-dropdown"
                            ...
                            <span class="d-flex align-items-center">
                                ...
                                <span class="text-start ms-xl-2">
                                    ...
                                    <span
                                        class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text">{{ role(auth()->user()->role_id) }}</span>
                                </span>
                            </span>
                        </button>
